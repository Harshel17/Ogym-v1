...
- **OGym Score System (V3 — Pattern-Aware):** Three-layer behavioral intelligence system:
    - **Layer 1 — Daily Fitness Score (0-100):** Personalized pillar-based scoring with baseline adaptation. 4 pillars: Workout (35%), Activity (30%), Nutrition (20%), Recovery (15%) with proportional weight redistribution based on user-selected pillars. Activity, Nutrition, and Recovery pillars use personal baseline adaptation: 70% global target + 30% personal improvement (14-day rolling average). Baseline cap: personal component cannot exceed global by more than +15 points. Workout stays binary (no baseline). Nutrition baseline uses compliance % (days meeting calorie/protein targets) not raw calories. Color zones: Green (90-100), Blue (70-89), Yellow (50-69), Orange (30-49), Red (10-29). Floor of 10 (never 0). Pending vs finalized logic for today vs past days.
    - **Layer 2 — Fitness Credit (0-1000):** Pattern-aware long-term score using 5 signals: Base Average 60% (recency-weighted 30-day), Consistency 20% (low variance rewarded), Trend 10% (week-over-week improvement), Streak 7% (consecutive days above score 40), Bounce-back 3% (recovery after missed days). Unlocks after 21 days (min 18 active). Tiers: Elite 750+, Strong 650+, Building 500+, Inconsistent 400+, At Risk <400. Pattern signals stored in ogym_scores.reasons field.
