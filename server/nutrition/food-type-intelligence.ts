...
const FOOD_KEYWORD_MAP: Array<{ keywords: string[]; type: string }> = [
  { keywords: ["pizza", "slice", "pie"], type: "pizza" },
  { keywords: ["wing", "wings", "buffalo wing", "chicken wing"], type: "wing" },
  { keywords: ["dosa", "dosai"], type: "dosa" },
  { keywords: ["idli", "idly"], type: "idli" },
  { keywords: ["roti", "rotis", "phulka"], type: "roti" },
  { keywords: ["naan", "nan"], type: "naan" },
  { keywords: ["paratha", "parantha", "pratha"], type: "paratha" },
  { keywords: ["biryani", "biriyani", "briyani", "biryanis"], type: "biryani" },
  { keywords: ["rice", "chawal", "chaval", "pulao", "pulav"], type: "rice" },
  { keywords: ["burger", "whopper", "big mac", "mcchicken"], type: "burger" },
  { keywords: ["sandwich", "sub", "hoagie", "panini"], type: "sandwich" },
  { keywords: ["taco", "tacos"], type: "taco" },
  { keywords: ["egg", "eggs", "omelette", "omelet"], type: "egg" },
  { keywords: ["samosa", "samosas"], type: "samosa" },
  { keywords: ["nugget", "nuggets", "mcnugget"], type: "nugget" },
  { keywords: ["cookie", "cookies"], type: "cookie" },
  { keywords: ["pancake", "pancakes", "hotcake"], type: "pancake" },
  { keywords: ["chapati", "chapatis", "chapathi"], type: "chapati" },
